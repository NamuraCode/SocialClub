...
namespace SocialClubExample.domain.model
{
    internal class Guest : User
    {
        ...
        public Guest(ulong register, ulong idGuest, Partner partner, bool status, ulong id, string name, int age, long cellphone, long document, string userName, string password, string role)
